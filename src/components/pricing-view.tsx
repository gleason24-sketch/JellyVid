  ...
  return (
    <div className="mx-auto max-w-4xl px-4 pb-20 pt-10">
      <h1 className="text-3xl font-extrabold sm:text-4xl">
        One rate. Every pack. <span className="jv-glow-pink text-[var(--color-pink)]">Forever.</span>
      </h1>
      ...
      {!paymentsEnabled ? (
        <div className="jv-card mt-6 border-[var(--color-yellow)] p-4">
      ...
      <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {CREDIT_PACKS.map((pack) => (
          <div key={pack.id} className="jv-card flex flex-col p-5">
      ...
      <h2 className="mt-14 text-2xl font-extrabold">What a generation costs</h2>
      <div className="jv-card mt-4 overflow-x-auto">
      ...
      <h2 className="mt-14 text-2xl font-extrabold">What we do not do</h2>
